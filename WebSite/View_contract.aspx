<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="View_contract.aspx.cs" Inherits="View_contract" %>

<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    <div class="content-header" style="text-align: left">View Contract</div>
    <div class="content">
        

        <asp:Button ID="BtnEditContract" class="btn btn-primary" runat="server" Text="Edit Contract" />
        <br />
        <br />
        <table>
            <tr>
                ...
                <td style="width: 500px">
                    <asp:TextBox ID="TxtCname" runat="server" ReadOnly="True" Width="458px"></asp:TextBox>
                </td>
                <td style="width: 74px">
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="width: 500px">
                    <asp:TextBox ID="TxtDescription" runat="server" Height="170px" TextMode="MultiLine" Width="461px" ReadOnly="True"></asp:TextBox>
                </td>
                <td style="width: 74px">
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="width: 500px">
                    <asp:DropDownList ID="DdField" Width="190px" runat="server" Enabled="False">
            ...
            <tr>
                ...
                <td style="width: 500px">
                    <asp:DropDownList ID="DdSal" Width="190px" runat="server" Enabled="False">
                            <asp:ListItem>Choose</asp:ListItem>
            ...
            <tr>
                ...
                <td style="width: 500px">
                    <asp:DropDownList ID="DdEdu" Width="190px" runat="server" Enabled="False">
                            <asp:ListItem>Choose</asp:ListItem>
            ...
            <tr>
                ...
                <td style="width: 500px; height: 22px;">
                    <asp:DropDownList ID="DdExp" Width="190px" runat="server" Enabled="False">
                            <asp:ListItem>Choose</asp:ListItem>
